<?php 
    ...
    if (isset($_POST['insertWebDevBtn'])) {
        $query = insertWebDev($pdo, $_POST['username'], $_POST['first_Name'], $_POST['last_Name'], $_POST['dob'], $_POST['specialization']);
    ...
    if (isset($_POST['editWebDevBtn'])) {
        $query = updateWebDev($pdo, $_POST['first_Name'], $_POST['last_Name'], $_POST['dob'], $_POST['specialization'], $_GET['web_dev_id']);
