        ...
        <table style="width:100%; margin-top: 50px;">
            ...
            <?php foreach ($getProjectsByWebDev as $row) { ?>
                <tr>
                    ...
                    <td><?= $row['technologies_used']; ?></td>	  	
                    <td><?= $row['project_owner']; ?></td>	  	
                    <td><?= $row['date_added']; ?></td>
                    <td>
                        <a href="edit_Project.php?project_id=<?= $row['project_id']; ?>&web_dev_id=<?= $_GET['web_dev_id']; ?>">Edit</a>

                        <a href="del_Project.php?project_id=<?= $row['project_id']; ?>&web_dev_id=<?= $_GET['web_dev_id']; ?>">Delete</a>
                    </td>	  	
                </tr>
        <?php } ?>
        </table>
